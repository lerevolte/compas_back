...
class InstallRelationsModule extends Command
{
    ...
    protected $description = 'Установить модуль «Связанные документы»: раздел и поля-связи у документов (заказы, задачи, записи на самовывоз, счета, расходные/приходные накладные, возвраты от покупателя, адреса, быстрые задачи), вкладка «Модули», заполнение из object_relations';
