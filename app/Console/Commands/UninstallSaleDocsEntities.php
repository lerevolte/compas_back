...
class UninstallSaleDocsEntities extends Command
{
    ...
    protected $description = 'Удалить сущности «Счета на оплату», «Расходные накладные», «Возвраты от покупателя», «Приходные накладные», вкладку «Печать документов» и поле «Банковские реквизиты» у заказов';
