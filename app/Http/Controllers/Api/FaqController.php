...
class FaqController extends Controller
{
    ...
    {
        $object = \App\Models\Faq::whereJsonContains('slug->value', $slug)->orWhere('slug', $slug)->first();
        if(!$object) {
            return [
                'error' => array(
