...
class Client extends Model
{
    ...
    {
        return $this->belongsToMany(Task::class, 'logistic_task_client')->withPivot('task_id', 'client_id');
    }

    public function sync_history($field, $new_value)
    {
        $objects = \App\Models\History::saveForObject('clients', array(['id' => $this->id, $field => $new_value]), false);
    }
