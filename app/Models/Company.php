...
class Company extends Model
{
    ...
    {
        return \App\Services\TypeTagService::add('companies', self::TYPE_FIELD_TITLE, $companyIds, $label);
    }

    public static function removeType($companyIds, string $label): int
    {
        return \App\Services\TypeTagService::remove('companies', self::TYPE_FIELD_TITLE, $companyIds, $label);
    }
