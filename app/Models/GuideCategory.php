...
class GuideCategory extends Model
{
    ...
    {
        return $this->belongsToMany(Guide::class, 'guide_category', 'category_id', 'guide_id');
    }


    public function sync_history($field, $new_value)
    {
        $objects = \App\Models\History::saveForObject('guide_categories', array(['id' => $this->id, $field => $new_value]), false);
    }
}
