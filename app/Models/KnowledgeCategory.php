...
class KnowledgeCategory extends Model
{
    ...
    {
        return $this->belongsToMany(Knowledge::class, 'knowledge_category', 'category_id', 'knowledge_id');
    }

    public function sync_history($field, $new_value)
    {
        $objects = \App\Models\History::saveForObject('knowledge_categories', array(['id' => $this->id, $field => $new_value]), false);
    }
