...
class OsagoModel extends Model
{
    use FieldValue, ModelActions, SoftDeletes;


    protected $guarded = ['id'];
    protected $table = 'osago_models';
    ...
    {
        $objects = \App\Models\History::saveForObject('osago_models', array(['id' => $this->id, $field => $new_value]), false);
    }
}