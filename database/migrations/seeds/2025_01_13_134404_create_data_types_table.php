...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('seeds')->create('data_types', function (Blueprint $table) {
            $table->comment('');
            ...
            $table->text('empty_text')->nullable()->default('Нет данных');
        });
    }
    ...
    {
        Schema::connection('seeds')->dropIfExists('data_types');
    }
};
