...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('seeds')->create('users', function (Blueprint $table) {
            $table->comment('');
    ...
    {
        Schema::connection('seeds')->dropIfExists('users');
    }
};
