...
(function (window, document, Math) {
  ...
  function init() {
    ...
    '</fieldset>' +
    '</div>' +
    '<div id="clr-swatches" class="clr-swatches"></div><button class="btn btn-primary js-btn-add-color">Сохранить</button>' + ("<button type=\"button\" id=\"clr-clear\" class=\"clr-clear\">" +
