            ...
            if (ctx.aoColumns[i].checkboxes){
               ...
               if(ctx.aoColumns[i].mRender === null){
                  colOptions['render'] = function(){
                     return '<div class="not-selectable disabled justify-content-center"><label class="checkbox-container"><input type="checkbox" class="dt-checkboxes js-checkbox-row" autocomplete="off"><span class="checkmark"></span></label></div>';
                  };
               }
