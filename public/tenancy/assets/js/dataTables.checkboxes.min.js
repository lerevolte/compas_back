...
/* eslint-enable */
   ...
   Checkboxes.prototype = {
      ...
      */
      _constructor: function ()
      {
         ...
         if(hasCheckboxes){
            ...
            if(hasCheckboxesSelectRow){
               ...
               console.log('SHOW SELECT INFO')
               if(ctx._select.info){
                  console.log('SHOW SELECT INFO1')
      ...
      showInfoSelected: function(){
         ...
         var dt = self.s.dt;
         var ctx = self.s.ctx;
         console.log('showInfoSelected')
         if ( ! ctx.aanFeatures.i ) {
            return;
         }
         console.log('showInfoSelected2')
         // Get index of the first column that has checkbox and row selection enabled
         var colIdx = self.getSelectRowColIndex();

         // If there is a column that has checkbox and row selection enabled
         if(colIdx !== null){
            console.log('showInfoSelected3')
            ...
            $.each( ctx.aanFeatures.i, function ( i, el ) {
               ...
               //if(countRows) {
	               if($output.text() !== 'Кликните по записи для выбора' ){
                     console.log('showInfoSelected5')
	                  $el.append($output);
	               }
	           // } else {
   ...
   */
   Checkboxes.defaults = {
      ...
      */
      selectAllRender: '<label class="checkbox-container m-auto"><input type="checkbox" class="dt-checkboxes" autocomplete="off"><span class="checkmark"></span></label>'
   };
