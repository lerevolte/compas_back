	...
	module.exports = Itinerary.extend({
		...
		_onWaypointsChanged: function(e) {
			...
			if (!this._plan.isReady()) {
                //console.log('_onWaypointsChanged')
				this._clearLines();
				this._clearAlts();
			}
		...
		_updateLineCallback: function(err, routes) {
			if (!err) {
                ...
                //console.log('_updateLineCallback')
				this._clearLines();
			}
		},
...
(function() {
	...
	module.exports = L.Class.extend({
		options: {
			serviceUrl: 'http://compas.pro/route/v1',//'https://router.project-osrm.org/route/v1',
			profile: 'driving',
			timeout: 30 * 1000,
			routingOptions: {
				alternatives: true,
