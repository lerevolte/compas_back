! function(e, t) {
    ...
    var t = L.MarkerClusterGroup = L.FeatureGroup.extend({
        ...
        removeLayer: function(e) {
            //console.log('remove layer markers')
        ...
        addLayers: function(e, t) {
            //console.log('add layers markers')
        ...
        removeLayers: function(e) {
            //console.log('remove layers markers')
            var t, i, n = e.length,
        ...
        clearLayers: function() {
            //console.log('clear layers markers')
        ...
        zoomToShowLayer: function(e, t) {
            //console.log('zoom to show layer')
        ...
        _generateInitialClusters: function() {
            ...
            console.log('this._gridClusters')
            console.log(this._gridClusters)
        },
    ...
    var i = L.MarkerCluster = L.Marker.extend({
        ...
        _addToMap: function(e) {
            ...
            if (this.getChildCount){
                ...
                this.setLatLng([from_avg.lat, from_avg.lng]);
                ////console.log('cluster group '+this._childCount+': '+total);  // return count of points within each cluster
            } else {
                this.setLatLng(e)
            }
