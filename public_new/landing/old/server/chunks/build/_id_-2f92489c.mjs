  ...
  setup(__props) {
    ...
    useHead({
      link: [
        {
          rel: "canonical",
          href: `https://compas.pro/questions/${route.params.id}`
        }
      ]
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/questions/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-2f92489c.mjs.map
