  ...
  setup(__props) {
    useHead({
      link: [
        {
          rel: "canonical",
          href: "https://compas.pro/questions-category"
        }
      ]
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/questions-category/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-59c0e016.mjs.map
