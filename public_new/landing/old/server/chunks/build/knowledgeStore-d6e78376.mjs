  ...
  getters: {
    ...
    articlesList() {
      ...
      if ((_a = route.params) == null ? void 0 : _a.id) {
        return ((_c = (_b = this.articles) == null ? void 0 : _b.list) == null ? void 0 : _c.data.filter((i) => {
          var _a2;
          return i.slug != route.params.id && ((_a2 = i == null ? void 0 : i.slug) == null ? void 0 : _a2.value) != route.params.id;
        })) || [];
      }
      return ((_e = (_d = this.articles) == null ? void 0 : _d.list) == null ? void 0 : _e.data) || [];
    },
    articlesCategories() {
      var _a;
    ...
    countPages() {
      var _a;
      return (_a = this.articles) == null ? void 0 : _a.list.last_page;
    }
  },
  actions: {
    async loadArticles() {
...
export { useKnowledgeStore as u };
//# sourceMappingURL=knowledgeStore-d6e78376.mjs.map
