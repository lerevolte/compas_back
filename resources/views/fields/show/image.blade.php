        ...
        <div class="position-relative">
            ...
            <div class="file-list">
                @if($value && (is_array($value) || is_object($value)))
                    @foreach($value as $val)
                        ...
                        <div class="file-item file-item-pdf file-list-item" data-id="{{ $val->id }}">
                            ...
                            <a href="{{ str_replace('/public', '', Storage::disk('public')->url($val->path)) }}" target="_blank">
                        ...
                        <div class="file-item file-list-item" data-id="{{ $val->id }}">
                            ...
                            <a href="{{ Storage::disk()->url($val->path) }}" data-fancybox="{{ $field_data->field }}-1">
                                <img src="{{ \Thumbnail::src('https://compas.pro'.Storage::disk()->url($val->path))->heighten(200)->url() }}" height="96">
                            </a>
                        </div>
                        @endif
                    @endforeach
                ...
                <label class="btn rounded-1 position-relative add-file-btn">
                    ...
                    Загрузить<input class="d-none js-file-list" type="file" name="{{ $field_data->field }}[]">
                </label>
            </div>
