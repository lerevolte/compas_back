<div class="js-editable" data-field="{{ $field->field }}" data-value="{{ isset($current) ? $current->{$field->field} : '' }}" @if($field->field == 'date_delivery_status') data-type="date" @else data-type="{{ $field->type }}" @endif style="{{ $field->label_color ? 'color:'.$field->label_color : ''}}">
