        ...
        <div class="mb-2 card p-3 bg-light">
                <div class="d-flex justify-content-start align-items-center" style="flex-grow: 1;">
                    ...
                    <h5 class="mb-0 w-100 js-relation-input d-flex align-items-center">
                        ...
                        <span class="empty-val js-link" data-href="/objects/{{ $field_details['table'] }}/show/{{ $object->id }}?ajax=Y">{{ $object->name }}</span>
                        <div class="position-relative w-100 d-none">
                            <div class="row g-2 flex-nowrap">
                                <div class="col-lg-12">
                                    <div class="position-relative">
            ...
            <div class="d-flex justify-content-start align-items-center" style="flex-grow: 1;">
                ...
                <h5 class="mb-0 w-100 d-flex align-items-center js-relation-input">
                    ...
                    @else
                        ...
                        @elseif($field_details['table'] == 'users' && $obj)
                            @php
                            $name = $last_name = '';
                            if($obj->name)
                            ...
                            @endphp
                            <div class="pic me-3" style="width:30px;height:30px;overflow: hidden;background: {{ $obj->getColor() }};">
                                {{ ucfirst($name).ucfirst($last_name) }}
                            </div>
                        @endif
                        @foreach($options as $k => $option)
                            @if($value == $k)
                            <span class="empty-val js-link" data-href="/objects/{{ $field_details['table'] }}/show/{{ $value }}?ajax=Y">{{ $option }}</span>
                            @endif
                        @endforeach
                    @endif
                    <div class="position-relative w-100 d-none">
