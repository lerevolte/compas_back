@php
$status_select = '<div class="form-group status-group js-editable disabled" data-id="'.$current->id.'">';
$tenant = tenant('id');
...
$status_select.= '<select name="'.$field->field.'" class="form-control form-control-status form-control-status-select field-status-select2 js-field-status" data-field="'.$field->id.'" data-color="'.$color.'">';
if($color != '')
