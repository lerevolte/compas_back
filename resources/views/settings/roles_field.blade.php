...
@section('subnav')
    <div class="t-nav mt-4">
        <div class="btn-group mb-3" role="group" aria-label="Nav">
            ...
            <a href="{{ route('settings.roles') }}" class="btn btn-outline-secondary active">Роли редактирования таблиц</a>
            <a href="" class="btn btn-outline-secondary">Кнопки</a>
        </div>
    </div>
@endsection
@section('content')
                ...
                <div class="col-lg-3 border-end">
                    ...
                    <div class="c-body p-0">
                        <ul class="c-drag-list list-unstyled mb-0 js-sort">
                            ...
                            <li class="side-list__item d-flex position-relative" data-id="{{ $item->id }}" data-model="roles" data-href="/roles/edit_field_perms/{{$item->id}}">
