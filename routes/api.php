...
Route::middleware([
    ...
    Route::name('api.')->group(function () {
        ...
        Route::get('logistic_tasks/{id}/saby-waybills', [App\Http\Controllers\Api\SabyWaybillController::class, 'index']);
        Route::post('logistic_tasks/{id}/saby-waybills', [App\Http\Controllers\Api\SabyWaybillController::class, 'store']);
        Route::get('logistic_tasks/{id}/saby-waybills/check', [App\Http\Controllers\Api\SabyWaybillController::class, 'check']);
        Route::get('logistic_tasks/{id}/saby-waybills/route-tasks', [App\Http\Controllers\Api\SabyWaybillController::class, 'routeTasks']);
